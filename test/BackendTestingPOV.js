...
//     // Test: Check that ticket can be minted
//     it('Check that ticket can be minted', async() =>{
//         // Set admin
...
//     // Test: Check that ticket can be purchased
//     it('Check that ticket can be purchased', async() =>{
//        // Set admin
//        let setAdmin = await userInstance.setAdmin(accounts[1], {from: accounts[0]});
